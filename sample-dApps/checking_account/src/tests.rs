...
async fn init_creates_instance_with_correct_balance() {
    ...
    let script_parameterized = checking_account_validator().unwrap();
    let spending_token_policy = vec![5, 5, 5, 5, 5];
    todo!()
    // let script = script_parameterized
    //     .apply(spending_token_policy.into())
    //     .unwrap();
...
async fn fund_account__replaces_existing_balance_with_updated_amount() {
    ...
    todo!();
    // let script = script_parameterized
    //     .apply(spending_token_policy.clone().into())
    //     .unwrap();
    // let address = script.address(NETWORK).unwrap();
    // let mut outputs_at_address = backend
    //     .ledger_client
    ...
    //     output_id,
    //     fund_amount,
    //     spending_token_id: hex::encode(spending_token_policy),
    // };
    //
...
async fn pull_from_account__replaces_existing_balances_with_updated_amounts() {
    ...
    let account_script_parameterized = checking_account_validator().unwrap();
    let spending_token_policy = vec![5, 5, 5, 5, 5];
    todo!();
    // let account_script = account_script_parameterized
    //     .apply(spending_token_policy.clone().into())
    //     .unwrap();
